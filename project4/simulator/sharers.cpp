...
{ 
#if 0
    // Isn't used anymore (in MOSI cache-to-cache causes livelock)!  Delete it outright?

    // its 2022 and i am including this commented code as a generous gift to
    // students. it has no relevance to the project whatsoever, but that just
    // makes it more special and unique. -austin
